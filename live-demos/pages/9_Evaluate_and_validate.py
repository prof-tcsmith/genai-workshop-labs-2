...
runs a small golden-set eval over the policy corpus, shows the results as a table
(with the source + retrieval scores behind each answer), demonstrates an
LLM-as-judge, checks a must-refuse case, and rolls it up into a go/no-go.
"""
